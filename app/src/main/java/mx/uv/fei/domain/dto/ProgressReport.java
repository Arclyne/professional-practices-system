...
/**
 * Representa un reporte de avance intermedio o final de un practicante.
 *
...
public class ProgressReport {
    ...
    public Date getPeriodCoveredStart() { return periodCoveredStart; }
    public void setPeriodCoveredStart(Date periodCoveredStart) { this.periodCoveredStart = periodCoveredStart; }

    public Date getPeriodCoveredEnd() { return periodCoveredEnd; }
    public void setPeriodCoveredEnd(Date periodCoveredEnd) { this.periodCoveredEnd = periodCoveredEnd; }

    public double getTotalHoursAtSubmission() { return totalHoursAtSubmission; }
    public void setTotalHoursAtSubmission(double totalHoursAtSubmission) { this.totalHoursAtSubmission = totalHoursAtSubmission; }
    ...
    public boolean equals(Object obj) {
        ...
        if (this == obj) {
            ...
            isEqual = this.practitionerId == other.practitionerId &&
                    Objects.equals(this.reportType, other.reportType);
        }
        return isEqual;
    }
